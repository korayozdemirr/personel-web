        ...
        <div className="container py-d9">
          <div className="row">
            ...
            <div className="col-lg-8">
              <p className="fs-3">
                {"I'm a MERN stack developer from Turkey. I create custom websitesto help businesses do better online"}
              </p>
              <p className="fs-4">
                I’ve always been passionate about coding, and I’m eager to apply
                my programming skills to new pursuits. I love to interact with
                my team setting sharing my skills and knowledge. Having been
                studied on several programming languages, I can easily learn a
                new programming language and develop innovative applications.
              </p>
              <hr />
